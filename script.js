...
function nextQ(){
  ...
  // Escribimos el texto de la pregunta, siempre excepto que la pregunta sea GUESS:
  if(current.tipo != 'guess'){
...
function renderNoEncaja(){
  ...
  // Mostrar pista si hay extra
  if(current.extra){
    const pista = document.createElement('div');
    pista.innerText = '💡 Pista: ' + current.extra;
    pista.style.marginTop = '10px';
    pista.style.fontSize = '0.95rem';
    a.appendChild(pista);
  }
}
